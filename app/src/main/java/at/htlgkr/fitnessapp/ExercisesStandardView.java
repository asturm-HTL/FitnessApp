...
public class ExercisesStandardView extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        listViewStandard.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                {
                    if((exBeforeSplit.get(n).toString().contains(listViewStandard.getItemAtPosition(position).toString())))
                    {
    ...
    public void startExerciseDetailed(String exerciseString)
    {
        ...
        handler.postDelayed(new Runnable()
        {
            ...
            public void run()
            {
                Intent intent = new Intent(ExercisesStandardView.this, ExerciseInDetail.class);
    ...
    public void onBackPressed()
    {
        ...
        handler.postDelayed(new Runnable()
        {
            ...
            public void run()
            {
                Intent intent = new Intent(ExercisesStandardView.this, MainActivity.class);
                startActivity(intent);
